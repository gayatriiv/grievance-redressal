            ...
            <div className="clean-card p-6">
              ...
              <div className="mt-6 space-y-3">
                ...
                {grievances.map((grievance) => (
                  <div key={grievance.id} className="flex flex-wrap items-center justify-between gap-4 rounded-2xl border border-border bg-background/40 p-4">
                    <div className="min-w-0">
                      ...
                      <p className="truncate text-sm font-medium text-foreground">{grievance.title}</p>
                    ...
                    <Link href={`/track/${grievance.id}`} className="shrink-0 rounded-full bg-foreground px-4 py-2 text-sm font-semibold text-background transition-opacity hover:opacity-90">
                      Track
                    </Link>
                  </div>
                ))}
