      ...
      <div className="mx-auto max-w-5xl space-y-8 px-6 pb-24 pt-3">
        ...
        {escalated > 0 && (
          <div className="rounded-2xl border border-amber-500/30 bg-amber-500/10 p-4">
            <p className="text-sm font-medium text-foreground">Automatic escalation is active on your account.</p>
            <p className="mt-1 text-sm text-muted-foreground">
              {escalated} grievance{escalated === 1 ? "" : "s"} exceeded the response window and were escalated to administrators for faster intervention.
            </p>
          </div>
        )}
